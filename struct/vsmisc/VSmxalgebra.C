...
/*----------------------------------------------------------------------------*/
double *VSrotatemx( angle, inMx, outMx )
...
/*----------------------------------------------------------------------------*/
double *VSscalemx( scale, inMx, outMx )
...
/*----------------------------------------------------------------------------*/
double *VStranslatemx( vector, inMx, outMx )
...
/*----------------------------------------------------------------------------*/
double *VSmirrormx( axis, inMx, outMx )

enum VSsymmetry	axis ;
const IGRmatrix	inMx ;
IGRmatrix	outMx ; {
	 ...
	 * VS_e_X_Symm  : x-axis
	 * VS_e_Y_Symm  : y-axis
	 * VS_e_XY_Symm : both x-axis & y-axis
	 */
	...
	switch( axis ) {
		case VS_e_X_Symm  : symMx[5] = -1 ; break ;
		case VS_e_Y_Symm  : symMx[0] = -1 ; break ;
		case VS_e_XY_Symm : symMx[0] =
				    symMx[5] = -1 ; break ;
	}
...
/*----------------------------------------------------------------------------*/
double *VSmulmx( inMx1, inMx2, outMx, outMxType )
