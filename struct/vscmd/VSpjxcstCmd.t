/*
	I/STRUCT
	"Project Cross-section Onto Surface" command.
*/
command_string	VSC_M_VSPrCrOnSr,0,VSPrCrOnSr
...
at init do message_key VS_M_VSPrCrOnSr
/*----------------------------------------------------------------------------*/
