command_string  GRMPlcNsidePoly,CO_ni_place_npoly_by_vertex,GRPNsPl
synonym         GRMPlcNsidePoly,CO_ni_place_npoly_by_vertex,EMPNsPl
class           COnpt
start_state     start
...
state start
   ...
   message_key GRC_M_PlcNsidePoly
   ...
   on SCALAR 
        ...
        do copy_event_by_index( sts, 3, 0 )       state have_number_of_sides
