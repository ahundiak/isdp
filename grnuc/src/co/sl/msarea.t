command_string  GRMMsAreaEle,CO_ni_measure_area,GRMArE   
class           COmeasure
start_state     start
...
state start
   message_key            GRC_M_MsAreaEle
   prompt_key             GR_P_IdEle
   accept_key             GR_P_AccMvOn
   locate_mask           "GRm_TEXT_VALUE | GRm_DATA"
   relocate_key           GR_E_CouNoFndEle
   locate_eligible       "+GRlinestr,GRplanar,GRconic,GRsubbc,GRcompcurve"
    locate_properties    "LC_LC_ONLY | LC_DP_ONLY | LC_RW | LC_PLANAR_ONLY | LC_PHY_CLOSED"
