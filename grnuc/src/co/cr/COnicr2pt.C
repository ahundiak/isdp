...

/* 
IGRlong CO_ni_place_circle_by_2pts_radius(
                msg,
                Events,
                DisplayMode,
                newflag,
...
/*----------------------------------------
 *  CO_ni_place_circle_by_2pts_radius
 *----------------------------------------
 */
IGRlong CO_ni_place_circle_by_2pts_radius(
                msg,
...

{
    ...
    _m_check2p( 
        status,
        *msg,
        "CO_ni_place_circle_by_2pts_radius - failed in CO_ni_place_circle." );
