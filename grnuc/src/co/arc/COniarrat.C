...
/* 
IGRlong CO_ni_place_arc_radcnt(
                msg,
                Events,
                DisplayMode,
                newflag,
...
Arguments
    ...
    struct GRevent   *events[]
        ...
        event[2] point 2.
        event[3] point 3.
        event[4] arc direction Event[4]->event.value = 0 clockwise or 
                   Event[4]->event.value = 1 for counterclockwise.
...

{
    ...
    *msg = MSSUCC;
    ...
    b_status =  GRarcnradpts(msg,
                            ...
                            &clock_flag,
                            &circle_arc);
    _m_check_boolp( b_status,"CO_ni_place_arc_radcnt - failed in ");
    ...
    _m_check2p( 
                status,
                *msg,
                "CO_ni_place_arc_radcnt - failed in co$construct object." );
