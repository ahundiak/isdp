...

/* 
IGRlong CO_ni_place_qrtel_axis(
                msg,
                Events,
                DisplayMode,
                newflag,
...
Abstract
    This function constructs a bspline representation of a elliptical arc, then
    ...
    IGRint                co_index;
{
    ...
    IGRlong             EventSize=sizeof( struct GRevent);
                                        /* size of event                */
    struct IGRbsp_curve *BsplineUsed;
     ...
     */
    GRconic_declare( ellipse, EllipsePolesetc );
...
/* EV - END OF VARIABLE LIST, USED FOR SEARCHING */
    ...
    *msg = MSSUCC;
    ...
    /*
     *  initialize the poles, weights, knots pointers in the ellipse 
     *  using the macro defined by eddie jennings
     */
    GRconic_init( ellipse, EllipsePolesetc );


    /*  
     *  ROUTER:
     *  Construct the nurb form of a ellipse given
    ...
    b_status = GReaaxptax( 
                    ...
                    &NumberOfEvents,
                    &ellipse );
    _m_check_boolp( b_status,"CO_ni_place_qrtel_axis - failed in GReaaxptax.");
    _m_check_boolq( b_status );
    _m_checkp( *msg, "CO_ni_place_qrtel_axis - failed in GReaaxptax." );
    _m_checkq( *msg );
     ...
     */
    EllipseGrid->osnum = ModuleInfo->md_id.osnum;
    ...
    _m_check2p( 
                status,
                *msg,
                "CO_ni_place_qrtel_axis - failed in co$construct object." );
