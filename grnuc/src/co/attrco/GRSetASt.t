...
/*
     ...
     GRSSt.sl - used for commands expecting a SCALAR or TEXT_VALUE
                   keyin. 
...
command_string      GRMSetST,"CO_style,0,1",GRSSt
synonym             GRMSetActSt,"CO_style,0,1",GRSSt
...
on NO_INPUT_PENDING      do message_key GRC_M_SetActSt
                         do prompt_key GR_P_EntNwSt      state get_input  
...
on SCALAR                do COdpb.put ( sts,
          ...
          on CO_E_INVINP do status_key GR_E_InvSt        state start
