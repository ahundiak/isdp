# $Id: make_dload.sh,v 1.2 2002/03/26 20:23:46 hans Exp $
...
# Revision History:
#	$Log: make_dload.sh,v $
#	Revision 1.2  2002/03/26 20:23:46  hans
#	commented bsot_sn5.a
#	
#	Revision 1.1.1.1  2001/01/04 21:07:29  cvs
#	Initial import to CVS
#
# Revision 1.2  1999/06/30  20:18:28  pinnacle
# bspmath update
#
# Revision 1.1  1998/04/29  16:27:20  pinnacle
# VDS 2.5.1
#
# Revision 1.3  1997/05/21  21:03:02  pinnacle
# Replaced: etc/bin/make_dload.sh for:  by impd for vds
#
# Revision 1.2  1997/05/15  17:23:24  pinnacle
# Replaced: etc/bin/make_dload.sh for:  by impd for vds
#
...
#	06/30/99	ah		Pull BSpl_pl_pl from nonpurified
...
#	fi
	...
	if  ${LD}	${LDOPT}		\
                        -o ${VDdloadObj}	\
			`find ${VDS}/lib -type file -name "vdi*.o" -print` \
			`find ${VDS}/lib -type file -name "smi*.o" -print` \
			${BSF}
	then
		RC=0
...
VDdloadPtch=""		# Dload directory in release version for patches
