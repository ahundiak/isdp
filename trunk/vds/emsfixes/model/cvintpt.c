/* $Id: cvintpt.c,v 1.2 2001/05/16 16:51:38 hans Exp $  */

/***************************************************************************
 * I/VDS
 *
 * File:	emsfixes/model/cvintpt.c
 *
 * Description:
 *		Overwritten to prevent crash from recursive function
 *		RearrangeList() -->> RearrangeCoincNodes() -->> malloc()
 *		when depth of recursive stack >= 100
 *		Introduce static counter: rearr_cnt & REARR_MAX_CNT (88)
 *
 * Dependencies:
 *
 * Revision History:
 *	$Log: cvintpt.c,v $
 *	Revision 1.2  2001/05/16 16:51:38  hans
 *	Fix for TR# MP4946
 *	
 *	Revision 1.1  2001/02/15 18:17:58  hans
 *	Fix for TR# MP4567
 *
 *
 * History:
 *	MM/DD/YY	AUTHOR		DESCRIPTION
 *	02/15/2001	HF		creation date
 *					Fix(/Kludge?) for TR# MP4567
 *	05/16/2001	HF		Fix for TR# MP4946
 *
 ***************************************************************************/
#include <stdio.h>
#include <malloc.h>
...
/*
 * HF: 02/15/2001   Fix(/Kludge?) for TR# MP4567
 */
