/* X-forms fix for EMS 3.2 (GRNUC dload delivery) */
/* TR 119525124  (X-forms TR 249504628)           */
...
/*	  gadget->FIgadget.symbol_ptr.bitmap = 0; */
  ...
  /* sml:08-24-95
	Fix EMS TR about scaling down in the y direction only causing
	EMS to terminate with X_CreatePixmap error message .
  */

  else if (gadget->FIgadget.symbol_ptr.sym_width == 0)
  {
  /* Do nothing */
  }
...
/*		 gadget->FIgadget.on_symbol_ptr.bitmap = 0; */
  ...
  */
  ...
  else if (gadget->FIgadget.on_symbol_ptr.sym_width == 0)
  {
  /* Do nothing */
  }
...
void _FI_g_change_symbol (struct FIgadget_obj *gadget)
{
   float delta_x;
   float delta_y;
   int xsize = gadget->FIgadget.xhi - gadget->FIgadget.xlo;
   int ysize = gadget->FIgadget.yhi - gadget->FIgadget.ylo;
