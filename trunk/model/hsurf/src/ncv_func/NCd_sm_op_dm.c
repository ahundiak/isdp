...
/*---NCupdate_smooth_dm_block_front_dexels------------------------------------*/

void NCupdate_smooth_dm_block_front_dexels( struct trapezoid *tile )
...
{                                                                       \
   ...
   {                                                                    \
      if( using_ptc )                                                   \
      {                                                                 \
         color = GET_SMOOTH_DM_COLOR_PTC;                               \
      }                                                                 \
      else                                                              \
      {                                                                 \
         color = GET_SMOOTH_DM_COLOR_RAMP;                              \
      }                                                                 \
                                                                        \
...
/*---NCupdate_smooth_dm_swvol_back_dexels-------------------------------------*/

void NCupdate_smooth_dm_swvol_back_dexels( struct trapezoid *tile )
...
/*---ASSIGN_SMOOTH_DM_SIM_DEXEL_FRONT-----------------------------------------*/

#define ASSIGN_SMOOTH_DM_SIM_DEXEL_FRONT(simdex, shadex)                \
                                                                        \
{                                                                       \
   ...
   if( using_ptc )                                                      \
   {                                                                    \
      simdex->near_c = simdex->far_c = GET_SMOOTH_DM_COLOR_PTC;         \
      shadex->near_c = shadex->far_c = rsc >> 16;                       \
   }                                                                    \
   else                                                                 \
   {                                                                    \
      simdex->near_c = simdex->far_c = GET_SMOOTH_DM_COLOR_RAMP;        \
   }                                                                    \
}
...
{                                                                    \
   ...
   {                                                                 \
      ASSIGN_SMOOTH_DM_SIM_DEXEL_FRONT(simdex, shadex)               \
   }                                                                 \
}
...
/*---NCupdate_smooth_dm_tool_front_dexels-------------------------------------*/

void NCupdate_smooth_dm_tool_front_dexels( struct trapezoid *tile )
...
/*---ASSIGN_SMOOTH_DM_SIM_DEXEL_BACK-----------------------------------------*/

#define ASSIGN_SMOOTH_DM_SIM_DEXEL_BACK(simdex, shadex)              \
                                                                     \
{                                                                    \
...
{                                                                     \
   ...
   {                                                                  \
      ASSIGN_SMOOTH_DM_SIM_DEXEL_BACK(simdex, shadex);                \
   }                                                                  \
}
...
/*---NCupdate_smooth_dm_tool_back_dexels--------------------------------------*/

   void NCupdate_smooth_dm_tool_back_dexels( struct trapezoid *tile )
