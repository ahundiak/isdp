/* - special convertion routine EMStorus_OMPORT_EMSsubbs - */
...
struct EMStorus_total_instance {
...
EMStorus_OMPORT_EMSsubbs(classid, ME, me)
short classid;
struct EMStorus_total_instance *ME;
