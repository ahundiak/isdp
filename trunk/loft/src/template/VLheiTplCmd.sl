/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ...
     CLASS NAME : VLheiTplCmd

     ABSTRACT   : I/LOFT evaluate templates heights
     ...
     NOTES	: This command object defines the classe VLheiTplCmd.
		  This command creates an ASCII file with outputs.


     CHANGE HISTORY : 	file created 	27-JUL-1994     Marc Fournier

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/


command_string	VLC_M_HEI_TEMPLATE, 0, VLHeTe
...
action VLgenerateList {
        ...
        status = VLexecHeiTemplateList ( me->Cnt1, me->Lst1, &me->Current,
                                         me->Wfile, "RPsetup", sts);
        as$status ( msg    = "VLexecHeiTemplateList()",
