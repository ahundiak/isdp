...
#define PRODNUM_LEN	32		/* expanded for "fat" product number */
#define DIR_LEN		128		/* expanded for huge directory depths */
#define	KEY_LEN		32		/* expanded for "fat" loadkey*/
...
#  define	RESTART			"deltools/restart.dat"
#  define	CPIO			"/bin/cpio"
#  define	FLOP_DEVICE		"/dev/floppy/fl0"
#  define	FLOP_RAW_DEVICE		"/dev/rfloppy/fl0"
#  ifndef CDROM_DEVICE
#    define	CDROM_DEVICE		"/dev/dsk/cdrom"
#  endif
#  define	TAPE_DEVICE		"/dev/rmt/0mn"
...
struct prodnode {
	...
	char	unixdir[DIR_LEN];	/*where to install the product*/
...
#define	NEEDS_UPDATING		0x0000
#define	WORKSTATION_NEWER	0x0001
#define	NEW			0x0002
#define	UP_TO_DATE		0x0003
...
#define	HAVEKEY			0x0100	/* is loadkey available on-line? */
	...
	unsigned long	arch;		/* Target architectures*/
