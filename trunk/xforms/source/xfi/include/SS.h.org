/* ------------------------------------------------
 * The original name of this file was interfering with the Smart Sketch file
 * Don't think it is really being used but if so then worry about it when we get there
 */
#ifndef SS_included
