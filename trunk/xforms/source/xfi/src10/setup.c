...
int FI_set_font_path (char *path)
{
  ...
  strcat(enhanced_font_path, "/resrc/bsfont:/opt/ingr/resrc/bsfont");
...
int FI_set_FSfont_path (char *FSfont_path)
{
  ...
  strcat(enhanced_FSfont_path, 
	"/resrc/fontserver/typeface:/opt/ingr/resrc/fontserver/typeface");
...
int FI_set_charmap_path (char *charmap_path)
{
  ...
  strcat(enhanced_charmap_path, 
	"/resrc/fontserver/charmap:/opt/ingr/resrc/fontserver/charmap");
                   ...
                   int  * font_type )
{
  ...
  if ( FI_font_strategy == FI_FS_FONTS_FIRST )
  {
     ...
     /* /opt/ingr/resrc/fontserver/typeface directory.  If is does  */
     /* then look to see if a *.cm file exists in the               */
     /* /opt/ingr/resrc/fontserver/charmap directory.  If the       */
	 ...
	 /* FI_data is set in _FI_find_closest_font */
	...
	else
	  {
	    ...
	    *********************************************************/
		...
		/* .tf in the /opt/ingr/resrc/fontserver/typeface  */
		/* directory.  If it does, then look to see if a   */
		/* .cm file exists in the                          */
		/* /opt/ingr/resrc/fontserver/charmap directory.   */
...
/* dmb:04/09/93:end addition */
  ...
  if ( path_name == NULL )
   {
/*      FI_set_FSfont_path ("/opt/ingr/resrc/fontserver/typeface"); */
      FI_set_FSfont_path (tmp_path);
   }
  else
   {
/*      strcpy (temp_path, "/opt/ingr/resrc/fontserver/typeface:"); */
...
/* dmb:04/09/93:end addition */
  ...
  if (path_name == NULL)
   {
/*      FI_set_charmap_path ("/opt/ingr/resrc/fontserver/charmap"); */
      FI_set_charmap_path (tmp_path);
   }
  else
   {
/*      strcpy (temp_path, "/opt/ingr/resrc/fontserver/charmap:"); */
      strcpy (temp_path, tmp_path );
      strcat (temp_path, ":");
