...
extern int PDUfind_dyn_attr_by_synonym __PDU((char *synonym, MEMptr attr_bufr));
...
/* ./catalogs/PDUcat_list.c */
extern int cat_list_notification_routine __PDU((int f_label, int g_label, double value, Form fp));
extern int PDUclass_cat_list_form __PDU((void));
...
extern int PDUprocess_selected_pulldown_value __PDU((int *act_row, int pos, int *list_size));

/* ./catalogs/PDUcatapi.c */
...
extern int PDUmadd_attribute_defaults __PDU((void));
...
extern int PDUcreate_new_dynamic_attr_buffr __PDU((MEMptr *dynamic_attr_buffr));
...
extern int PDUget_filename_for_part __PDU((char *catalog, char *partid, char *revision, char **filename));
extern int PDUget_parttype __PDU((char *catalog, char *part, char *revision, char **parttype));
extern int PDUcreate_dynamic_arrays __PDU((MEMptr dyn_attr, MEMptr dyn_data, int *dyn_count, char ***dyn_attr_names, char ***dyn_attr_values));
extern void PDUcleanup_refresh __PDU((void));
...
extern int PDUprocess_move_to_next_state __PDU((void));
extern int PDUcheck_all_parametric_parts_exist __PDU((MEMptr attr_bufr, MEMptr data_bufr, char *msg));
extern int PDUcheck_all_parametric_parts_dup __PDU((MEMptr attr_bufr, MEMptr data_bufr, char *msg));
extern int PDUupdate_parmpart_function_value __PDU((char *function_value));
...
/* ./catalogs/PMapi_cat.c */
extern void pdmoCreateCatalog __PDU((int *status, char *catalog, char *description, char *acl_name, char *temp_cat, struct PDUattribute_info *static_attr, struct PDUattribute_info *dynamic_attr, char *catalog_type));
