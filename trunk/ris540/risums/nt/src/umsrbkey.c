...
int	UMSRetPtrByKey( msgPtr, msgLen, msgKey )
...
int	_UMSReturnByKey( textBuf, msgKey )
...
int	_UMSInterpretKey( msgHdr, idx, msgKey )
...
int	_UMSFindFileKidx( idx, msgHdr, msgExt )
...
int	_UMSFindMemKidx( idx, msgHdr, msgExt )
...
int	_UMSFindFileKey2( msgHdr, idx, msgKey2 )
  UMSHeader	**msgHdr;    /* o - In-memory message file data	     */
...
int	_UMSFindMemKey2( msgHdr, idx, msgKey2 )
  UMSHeader	**msgHdr;    /* o - In-memory message file data	     */
  int		*idx;	     /* o - "Index" into secondary key block */
  char		*msgKey2;    /* i - Secondary message key	     */
{
...
int	_UMSSearchFileBlock( idx, key, filePos, blockSize )
