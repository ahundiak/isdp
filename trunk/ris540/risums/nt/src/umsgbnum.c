...
#include <stdarg.h>
#include "pums_all.h"   /* sml:06-25-93 include pums_all.h for all prototypes */
...
**********************************************************************/
/*	sml:10-07-91	ansi-ize, remove variable (4th) argument
int UMSGetByNum ( msgBuf, msgNum, msgFmt )
...
int UMSGetByNumVar( msgBuf, msgNum, msgFmt, vars )
  char	msgBuf[];	/* o - Buffer for resulting message	*/
