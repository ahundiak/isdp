...
Description:   Dynamic Dialog Functions
...
static LPDLGITEMTEMPLATE GetDlgItemTemplateVarInfo(LPDLGITEMTEMPLATE,LPDLGITEMTEMPLATEVARINFO);
...
// -----------------------------------------------------------------------
static LPVOID AlignToNextDlgItem(
	LPVOID lpvResItem)
{
  ULONG ul;
...
// -----------------------------------------------------------------------
static LPTSTR CopyResourceString(
	LPSTR lpszDest,
	LPRSTR lprszRes,
	int cchDest)
{
...
//lstrcpyn(lpszDest, lprszRes, cchDest);//rick
strncpy(lpszDest, lprszRes, cchDest);//rick
...
//      not required. 
// -----------------------------------------------------------------------
LPDLGITEMTEMPLATE GetDlgItemTemplateVarInfo(
...
//rlk      lstrcpyn(lpditvi->lpszClassName, lpszWinCtlClass[iClass],
strncpy(lpditvi->lpszClassName, lpszWinCtlClass[iClass],
...
strncpy(lpditvi->lpszTitle, szNum, lpditvi->cchTitle);
    }
...
//      FALSE = Failure.
// -----------------------------------------------------------------------
extern BOOL DestroyDlgCategoryControls(
	LPDLGCATEGORY lpdlgcat)
{
  int                   i;
  NPHWND                nphwnd;
...
// -----------------------------------------------------------------------
extern BOOL CreateDlgCategoryIndirect(
	LPDLGCATEGORY lpdlgcat,
	HWND hwndDlg,
	int nFrameID)
{
