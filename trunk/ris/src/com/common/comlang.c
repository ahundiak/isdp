...
extern struct ris_lang_info *RIScom_get_lang_info(int input_type,void *inptr);
extern void                  RIScom_term_langs();

static char *read_next_line();
static void  read_lang_info(char *buffer);
static char *remove_lead_n_trail_spaces(char *src);
