...
Purpose: 	This header file defines all common variables
	used by the communication interface libraries comtcp.c
	and comxns.c.
...
/* SGI compiler cribs about multiply defined symbols
   if if finds this file included in more than 1 cfile. MaC */
#if defined (__sgi)

/* Define structures for polling */
extern struct t_call *calls[ MAX_CONN_IND ];		/* Table of outstanding connections */
extern struct pollfd poll_info[2];			/* Structure for poll()ing streams */

extern int xns_max, tcp_max;	/* Maximum number of outstanding XNS and TCP connect indications */
/* Define structures for polling */
#else
