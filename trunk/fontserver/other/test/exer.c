...
/** capability of creating a font and displaying it.  Memory leaks can	**/
/** be found by montioring its memory usage with ps.			**/
/** Note:  This program does is not for testing shared fonts		**/
/** because it creates the same font over and over.			**/
...
char *argv[];
{
    ...
    Inq_displayed_vs (&vs);
    Create_win (vs, "Exercise", 40, 40, 1040, 820, &window);
