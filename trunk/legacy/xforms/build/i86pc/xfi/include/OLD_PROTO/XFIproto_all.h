...
/* SS.c */
extern int _FI_16DrawText(int window, FontId font, FontId fontAUX, unsigned char *text, int length, Real64 x, Real64 y, Real64 *nx, Real64 *ny, int mode, int screen);
