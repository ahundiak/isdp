...
# 09/01/92   dmb     Slight modifications for single directory components.
...
mkptypes -e -A $FILE_LIST |
  sed '/API_HANDLE_SHUTDOWN/d' >./NEW_PROTO/XFUproto_all.h


###############################################################
### Extract private functions from XFUproto_all.h create XFUproto_pri.h
###############################################################

# Put header at beginning of XFUproto_pri.h ###
cat pri_hdr >./NEW_PROTO/XFUproto_pri.h

#  Get private functions
   cat ./NEW_PROTO/XFUproto_all.h 		>>./NEW_PROTO/XFUproto_pri.h
#   egrep -e ' \*_| _|/\*' ./NEW_PROTO/XFUproto_all.h 		>>./NEW_PROTO/XFUproto_pri.h
#egrep -v -e ' \*_| _|/\*' ./NEW_PROTO/XFUproto_all.h | grep .	>>./NEW_PROTO/XFUproto_pub.h
# Put footer at beginning of XFUproto_pri.h ###
cat pri_ftr >>./NEW_PROTO/XFUproto_pri.h

################################################################
### Check generated prototype files against the official copies.
################################################################

PROTO_FILE_LIST="XFUproto_all.h \
                 XFUproto_pri.h"
