...
#
#	4. The shell script fixfname.sh and the ppl program fixfnameb.e
...
if [ "$#" -lt 1 ]
then
	echo "Usage: fixfname.sh <dirname> "
...
do
	echo $file
	$EMS/bin/ems -b -f $file -C' "ci=fixfnameb" '
done
