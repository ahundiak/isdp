...
extern void MRPdyn_text __PDU((int x_start_pos, int y_start_pos, int body_size, Form mrp_form_id, char *text_string, int glabel, int color));
extern void MRPdyn_rect __PDU((int x_lo_pos, int y_lo_pos, int x_hi_pos, int y_hi_pos, Form mrp_form_id, int glabel, int color));
