...
/********************************************************************
 *                                                                  * 
 *  Function : WFFchange_workflow                                   *
 *                                                                  * 
 *  This function is the driver for the change_workflow  (forms)    * 
 *                                                                  * 
 ********************************************************************/

long WFFchange_workflow (workflow_name, curr_page)
     char *workflow_name;
     int  curr_page;
  {
	long	status;

	static	char *fname = "WFFchange_workflow";
	...
	ptr->type = WFF_CHANGE_WF_TYPE;  
	ptr->done = FALSE;
	ptr->curr_page = curr_page;
