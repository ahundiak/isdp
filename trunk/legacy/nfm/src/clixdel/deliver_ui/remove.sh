...
nfmsrv=`grep SR01094AA-0305A /usr/ip32/ingrconfig`
...
y*|Y*)
    dbasrv="Y"
    echo "\nRemoving $PRODUCT_ID (DBA/NFM) Server Software"
    rm -r ../bin/dbasrv                                >/dev/null 2>&1
    ;;
*)
    ;;
esac
