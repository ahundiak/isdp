...
Pcs_Size=5100
Adm_Size=4500
# Nfmconvert Utility no more delivered - Jujare, 16-May-95 
#Cvt_Size=3800
Fls_Size=1700
Uti_Size=2000
Msg_Size=625
...
Dbasrv_Size=`expr $Fls_Size + $Msg_Size`
...
curnfmver=`grep SR01094AA-0305A /usr/ip32/ingrconfig | cut -f4 -d"#"`
...
echo "is now delivered with I_NFMUI (SR01095AA-0305A)."
...
#
# Nfmconver Utility no more delivered - Jujare, 16-May-95 
#
#if [ "$cvtans" = "y" ]
#then
