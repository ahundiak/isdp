...
long NFMRcheckout_set (catalog_name, catalog_no, set_name, set_revision, 
...
static char *fname = "NFMRcheckout_set";
    ...
    status = NFMcl_send_buffer (&NFMRglobal.NETid, NFM_CHECKOUT_SET, info);
