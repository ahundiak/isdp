...
long NFMSupdate_set_members (in_list)
...
static char *fname = "NFMSupdate_set_members";
...
ret_status = NFMupdate_set_members (user_id, attr_list, data_list);
_NFMSdebug(( fname, "NFMupdate_set_members <0x%.8x>\n", ret_status));
