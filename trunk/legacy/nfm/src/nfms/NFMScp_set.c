...
long NFMSprepare_set_copy (in_list)
...
static char *fname = "NFMSprepare_set_copy";
...
ret_status = NFMprepare_set_copy (user_id, data_ptr[1], data_ptr[2],
                 data_ptr[3], level, &attr_list, &data_list);
_NFMSdebug(( fname, "NFMprepare_set_copy <0x%.8x>\n", ret_status));
...
long NFMScancel_set_copy (in_list)
...
static char *fname = "NFMScancel_set_copy";
...
ret_status = NFMcancel_set_copy (user_id, attr_list, data_list);
_NFMSdebug(( fname, "NFMcancel_set_copy <0x%.8x>\n", ret_status ));
...
long NFMScomplete_set_copy (in_list)
...
static char *fname = "NFMScomplete_set_copy";
...
ret_status = NFMcomplete_set_copy (user_id, data_ptr[1], data_ptr[2], 
		data_ptr[3],data_ptr[4], data_ptr[5], attr_list, data_list);
_NFMSdebug(( fname, "NFMcomplete_set_copy <0x%.8x>\n", ret_status ));
