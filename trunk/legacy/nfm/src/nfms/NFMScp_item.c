...
long NFMSprepare_item_copy (in_list)
...
static char *fname = "NFMSprepare_item_copy";
...
ret_status = NFMprepare_item_copy (user_id, data_ptr[1], data_ptr[2],
                                   data_ptr[3], &attr_list, &data_list);
_NFMSdebug(( fname, "NFMprepare_item_copy <0x%.8x>\n", ret_status));
...
long NFMScancel_item_copy (in_list)
...
MEMptr attr_list = NULL;
MEMptr data_list = NULL;
static char *fname = "NFMScancel_item_copy";
...
_NFMSdebug(( fname, "NFMcancel_item_copy <0x%.8x>\n", ret_status));
...
long NFMScomplete_item_copy (in_list)
...
MEMptr attr_list = NULL;
MEMptr data_list = NULL;
static char *fname = "NFMScomplete_item_copy";
...
status = NFMcomplete_item_copy (user_id, data_ptr[1], data_ptr[2], data_ptr[3],
                               data_ptr[4], data_ptr[5], attr_list, data_list);
_NFMSdebug(( fname, "NFMcomplete_item_copy <0x%.8x>\n", ret_status));
