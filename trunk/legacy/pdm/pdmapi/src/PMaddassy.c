...
int pdmoAddPartToAssembly (char *cpr_catalog, char *cpr_partnum, char *cpr_revision, struct PDMassembly_member *spr_PDMadd_to_structure)

{
char *fname = "pdmoAddPartToAssembly";
PDMchildren spr_PDMstructure = NULL, spr_current_node = NULL;
PDMchildren  spr_temp = NULL;
