...
#if defined(sco) || defined(DOS) || defined(WIN32) || defined(vms)
#include "comisfn.prt"
#endif
#include "comjmp.prt"
...
extern void RISapp_adjust_parms(
	sqlda	*parms,
	char	*buf)
{
	int	i;
...
extern void RISapp_fill_blob_parms(
	sqlvar *output_sqlvar,
	int text_type,
	int *array_full
	)
{
...
extern void RISapp_process_parms(
	sqlda	*source,
	sqlda	*dest,
	int		input)
{
...
extern void RISapp_process_one_parm(
	sqlda	*source,
	sqlda	*dest,
	int		input,
	int		iparam)
...
extern void RISapp_process_blob_parms(
