/* $Id: VRrwfrrpCmd.sl,v 1.1.1.1 2001/01/04 21:12:58 cvs Exp $  */

/*************************************************************************
 * I/ROUTE
 *
 * File:	vrnetworkco/VRrwfrrpCmd.sl
 *
 * Description:
	"R'way From To Report" command.
 *
 * Dependencies:
 *
 * Revision History:
 *	$Log: VRrwfrrpCmd.sl,v $
...
# route 2.5
#
# Revision 1.3  1997/03/05  20:06:02  pinnacle
# Replaced: vrnetworkco/VRrwfrrpCmd.sl for:  by lawaddel for route
#
# Revision 1.1  1996/07/25  18:25:44  pinnacle
# Creation of Route 241 project
#
# Revision 1.2  1995/12/08  21:23:00  pinnacle
# Replaced: vrnetworkco/VRrwfrrpCmd.sl for:  by r240_int for route240
#
 *
 * History:
...
command_string	VRC_M_GnRwFTRp,0,VRGnRwFTRp
class		VRrwfrrpCmd
...
state start
	...
	message_key		VR_M_GnRwFTRp
	prompt_key		VR_P_SelTipNetWrk
	locate_class		"VRRComp | VRRCComp"
 ...
 */
  ...
  me->RepValue[9].type =  VR_REP_NOT_DEF;
