...
ALL: clipper_all sun_all mips_all hp_all
...
archive: sun_archive clipper_archive mips_archive
sharable: sun_shlib_prep clipper_shlib mips_shlib_prep
EVENTUALsharable: sun_shlib_prep clipper_shlib_prep mips_shlib_prep

hp_all: CHNG_IDENT hp_archive
hp_fast: hp_archive
...
hp_archive: CREATE_DIR fpi.o $(c_objects) init_arch.o
	@# fpi_init.o - Attach "init_arch.o" to "fpi.o" to make sure
	@# "init_arch.o" gets pulled into the application linking with libXFI.a
