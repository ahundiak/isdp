...
extern int errno; // 23 Mar 2010 - ah - guess we need this now
                      ...
                      int  ypos)
{
  ...
  int xsize = form->xhi - form->xlo;
  int ysize = form->yhi - form->ylo;
                  ...
                  int  ysize)
{
  ...
  int form_xlo = form->xlo;
  int form_ylo = form->ylo;
  int form_xhi = form->xhi;
  int form_yhi = form->yhi;
