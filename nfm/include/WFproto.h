...
extern long WFload_classes_list __WF((long user_id, MEMptr attr_list, MEMptr data_list, char *inlinx));
...
extern long WFload_commands_list __WF((long user_id, char *app_name, MEMptr attr_list, MEMptr data_list, char *inlinx));
...
extern long WFload_states_list __WF((long user_id, MEMptr attr_list, MEMptr data_list, char *inlinx));
...
extern long WFload_trans_acc_list __WF((long user_id, long no_classes, MEMptr trans_attr, MEMptr trans_data, MEMptr access_attr, MEMptr access_data, char *inlinx));
...
extern long WFload_workflow_list __WF((long user_id, MEMptr attr_list, MEMptr data_list, char *inlinx, char *workflow_name));
