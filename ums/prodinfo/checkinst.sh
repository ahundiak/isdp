...
# dmb:04/05/93:Changing to use cat here-is doc since print is ksh, not sh.
...
# dmb:04/05/93:Changing to use cat here-is doc since print is ksh, not sh.
#     print "$USAGE" >&2
# dmb:04/05/93:Also changed this since sh seems to care...
#     return 1
...
# dmb:04/05/93:SUNOS5 says: cannot return when not in function
exit $CheckResult
#return $CheckResult
#
