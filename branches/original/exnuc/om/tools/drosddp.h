...
struct dros_sd_parent {
   ...
   char           class[1];                     /* change to classid later */
};
typedef struct dros_sd_parent DROS_S_PARENT;

struct dros_sd_rest {
   char        class[DROS_K_CLASSNAME_MAX];     /* change to classid later */
   char        chan[DROS_K_CHANNAME_MAX];       /* channel name            */
