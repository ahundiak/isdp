[
n_catalogname(char[12])=AAS_channel
n_catalogdesc(char[100])=Parametric Catalog for AAS_channel
...
p_u0|n_itemrev(char[15])=Material
...
p_s10|flgThickness(double)=flgThickness
p_s11|webThickness(double)=webThickness
