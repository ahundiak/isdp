...
IGRint EFdypt7_6f8v( pt3, pt4, pt5, pt6, display )
 IGRpoint            pt3, pt4, pt5, pt6;
 struct IGRdisplay   *display;

{
 struct       pt7_struct    header;
 ...
 /*  INVOKE DYNAMICS  */
 dp$dynamics( dyn_fun = EFdyrbpt7_6f8v, information = &header );
...
/*
NAME    EFdyrbpt7_6f8v -->  function called by dp$dynamics to put new
                            stuff in
DESCRIPTION
...
IGRint EFdyrbpt7_6f8v( header, cursor_pt, matrix, objects, num_objects,
