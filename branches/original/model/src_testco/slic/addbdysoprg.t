command_string  GRC_M_AdBnOpRg,0,GRAdBnOpRg
class           ECaxhatch
...
state have_xhatch_objects
  ...
  locate_properties "LC_LC_ONLY | LC_PLANAR_ONLY | LC_DP_ONLY | LC_PHY_CLOSED" 
  ...
  locate_display  "ELEM_HILIGHT | NO_PROJ_ACCEPT_POINT | ALL_WINDOWS | LC_ERASE_ALL" 
   ...
   on DATA 
	...
	do is_this_a_hole
           on SUCCESS
	        do status_key GR_E_GeomIsBdry             state .
   ...
   on EX_RJT_MOVEON          
        ...
        do erase_hilite
        do add_remove_holes(1)
        do status_key GR_I_BndAdded
        do display_mode GRbd
        do display_second_located_object                   state start

   on EX_BACK_UP
	do delete_last_entry_collection
        do display_mode GRhhd
        do display_collection
                                                          state -
