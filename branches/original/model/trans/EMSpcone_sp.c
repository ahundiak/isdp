/* - special convertion routine EMSpcone_OMPORT_EMSsubbs - */
...
struct EMSpcone_total_instance {
...
EMSpcone_OMPORT_EMSsubbs(classid, ME, me)
short classid;
struct EMSpcone_total_instance *ME;
