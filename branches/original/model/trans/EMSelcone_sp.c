/* - special convertion routine EMSelpcone_OMPORT_EMSsubbs - */
...
struct EMSelpcone_total_instance {
...
EMSelpcone_OMPORT_EMSsubbs(classid, ME, me)
short classid;
struct EMSelpcone_total_instance *ME;
