...
/*
     ...
     GRSCl.sl - used for commands expecting a SCALAR or TEXT_VALUE
                   keyin. 
...
command_string  GRMSetCO,"CO_color,0,1",GRSCl
synonym         GRMSetActCo,"CO_color,0,1",GRSCl
class		COattr
product_name	"$SOURCE"
super_class     COtools
super_class     COdpb
...
on NO_INPUT_PENDING      do message_key GRC_M_SetActCo
                         do prompt_key GR_P_EntNwCo      state get_input
...
on SCALAR      do COdpb.put ( sts,
               ...
               on CO_E_INVINP
                         do status_key GR_E_InvCo        state start
