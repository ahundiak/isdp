...
Description
  State table for "Place Vertical Line" command
...
command_string  GRMPlcVertline,CO_ni_place_vertical_line,GRPVrL   
synonym         GRMPlcVertline,CO_ni_place_vertical_line,EMPVrL   
class           COnpt
start_state     start
