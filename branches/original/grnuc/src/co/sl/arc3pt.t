...
Description
  State table for "Arc by 3 pts" (an obsolete command)

Notes


 */
command_string  GRMPlcArc3Pts,CO_ni_place_arc_3pts,GRPAr3Pn 
synonym         GRMPlcArc3Pts,CO_ni_place_arc_3pts,EMPAr3Pn 
class           COnpt
