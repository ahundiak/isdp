...
/* EV - END OF VARIABLE LIST, USED FOR SEARCHING */
    ...
    *msg = MSSUCC;
    ...
    b_status = GReaaxaxpt( 
                    ...
                    &NumberOfEvents,
                    &ellipse );
    _m_check_boolp( b_status,"CO_ni_place_heal_axis - failed in GReaaxaxpt.");
    _m_check_boolq( b_status );
    _m_checkp( *msg, "CO_ni_place_heal_axis - failed in GReaaxaxpt." );
    _m_checkq( *msg );
    ...
    _m_check2p( 
                status,
                *msg,
                "CO_ni_place_heal_axis - failed in co$construct object." );
