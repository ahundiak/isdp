...
extern char * glXQueryExtensionsString ( Display *dpy, int screen );
extern char * glXGetClientString ( Display *dpy, int name );
extern char * glXQueryServerString ( Display *dpy, int screen, int name );
