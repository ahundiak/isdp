...
extern int NET_invalidate_connection(
	net_s   *net)
{
...
extern int NET_init_lang(
	net_s   *net,
	char    *ums_file)			/*  UMS dir */
{
...
extern void NET_set_debug_handler(
...
/******************************************************************************/
extern int Net_Error_Return_Function (
	net_s	*net 
)
{
	NET_ERROR_RETURN (net) ;
