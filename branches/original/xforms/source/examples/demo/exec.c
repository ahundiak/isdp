...
extern int DEMO_process_command();
extern int DEMO_do_msg_box();
extern Form form;
...
char *argv[];
{
  ...
  FI_modify_env ( FI_PROCESS_DATA,	DEMO_process_command );



    /***********************************/
    /*** initialize the Menus system ***/
    /***********************************/
