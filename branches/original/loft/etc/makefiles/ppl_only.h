# $Id: ppl_only.h,v 1.1 2001/04/06 17:17:46 ahundiak Exp $ 
...
pplmkfile: ${TGT}.m
	...
	then \
	   ksh $(LOFT_PATH)/etc/bin/mkmkppl ${TGT}.m pplmkfile $(SP); \
	else \
	   ksh $(LOFT_PATH)/etc/bin/mkmkppl ${TGT}.m pplmkfile $(LOFT); \
	fi
