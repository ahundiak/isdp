...
/* ---------------------------------------------------------------------------
 ...
 IGRlong DYrb_line_active_angle( Events,
                                 ActiveDisplay )
...
IGRlong DYrb_line_active_angle( Events, ActiveDisplay )
...

{
     ...
     */
    NumberOfBytes = sizeof( ActiveAngle );

    _m_debug_str( "COnilsactang: gr$get_active_angle" );
    gr$get_active_angle(
            msg    = &LocalMsg,
    ...
    _m_checkp( LocalMsg, "DYrb_line_active_angle: gr$get_active_angle failed" );
    _m_checkq( LocalMsg );
    _m_debug( printf("DYrb_line_active_angle: ActiveAngle = %f\n",ActiveAngle));
