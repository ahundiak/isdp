...
command_string  GRMPlcQrtEll,CO_ni_place_qrtel_axis,GRPQrElAx  
class           COnpt
...
at   init   do construct_class  "GR3dellarc"


state start
   message_key      GRC_M_PlcQrtEll
