/*\
Description
   The REFERENCE FILE LAYERS OFF command is used to define the layers 
   which are to be turned off for a reference file or a drawing view.
...
command_string  GRMRefFlLyOff,CO_layeroff,GRTrOfLyRf
synonym         GRMMdlVwLyOff,0,GRTrOfRfFl      /* KLUDGE for 1.2 only */
class           COdetail
super_class     COtools
...
on STRING      do COtools.erase_highlight()
               ...
               do change_drawview_layers (sts, 0)
                                                state have_drawview
