/* $Id: edptproj.c,v 1.1 2001/06/22 14:54:03 hans Exp $  */

/***************************************************************************
 * I/VDS
 *
 * File:	emsfixes/model/edptproj.c
 *
 * Description:
 *		Overwritten to prevent sqrt() DOMAIN error's, caused by
 ...
 * Revision History:
 *	$Log: edptproj.c,v $
 *	Revision 1.1  2001/06/22 14:54:03  hans
 *	No TR# Fix for sqrt() DOMAIN error
 *	
 *
 * History:
 *	MM/DD/YY	AUTHOR		DESCRIPTION
 *	06/22/2001	HF		creation date
 *					No TR# Fix for sqrt() DOMAIN error
 *
 ***************************************************************************/
#include <stdio.h>
