...
/*---HSconstant_shade_trans_direct------------------------------------------------------*/
	...
	void HSconstant_shade_trans_direct( struct trapezoid *tile )
#else
	void HSconstant_shade_trans_direct( tile )
...
#ifdef PSUEDO_COLOR
/*shift the intensity 16 for more accuracy during calculations*/
	rsc = (tile->shade0) << 16;
#else
