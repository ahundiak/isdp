...
/*---HSconstant_shade_opaque_half------------------------------------------------------*/

#if defined(__STDC__) || defined(__cplusplus)
	void HSconstant_shade_opaque_half( struct trapezoid *tile )
#else
	void HSconstant_shade_opaque_half( tile )
	...
	CHECK_BRIGHT_TOP_BOTTOM_DITHER
	MOVE_TO_NEXT_ROW
