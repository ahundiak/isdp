...
/*	for use with the "forms environment interface" functions. */
/******************************************************************/
...
#define  FI_VSYNC 			70
#define  FI_WEIGHT 			71
#define  FI_GET_SCRAP			82
#define  FI_PUT_SCRAP			84
...
#define FI_TOG_PUSH_MODE 18     /* ctrl r */
