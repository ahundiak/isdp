/* - special convertion routine EMSsphere_OMPORT_EMSsubbs - */
...
struct EMSsphere_total_instance {
...
EMSsphere_OMPORT_EMSsubbs(classid, ME, me)
short classid;
struct EMSsphere_total_instance *ME;
