/* - special convertion routine EMSelpsoid_OMPORT_EMSsubbs - */
...
struct EMSelpsoid_total_instance {
...
EMSelpsoid_OMPORT_EMSsubbs(classid, ME, me)
short classid;
struct EMSelpsoid_total_instance *ME;
struct EMSsubbs_instance *me;
{
	...
	char	*data;
  	unsigned char prop;
	extern  EMSrevol_OMPORT_EMSsubbs();
