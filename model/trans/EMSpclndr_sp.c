/* - special convertion routine EMSpcylindr_OMPORT_EMSsubbs - */
...
struct EMSpcylindr_total_instance {
...
EMSpcylindr_OMPORT_EMSsubbs(classid, ME, me)
short classid;
struct EMSpcylindr_total_instance *ME;
