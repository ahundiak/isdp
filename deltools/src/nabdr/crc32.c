/*
******************************************************************************
** $Id: crc32.c 1.1.1.1.1.1 1997/09/08 21:48:36 pinnacle Exp $
******************************************************************************
** Module: crc32.c
**
...
#if defined(__STDC__)
int bufcrc (register unchar *buf, register ulong buf_size, ulong *crc)
#else
    int bufcrc (buf, buf_size, crc)
    register unchar *buf;
    register ulong buf_size;
    ulong *crc;
#endif
{
