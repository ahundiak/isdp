/* $Id: PDMloc_part.c,v 1.1 2003/03/12 20:20:49 ahundiak Exp $  */

/* --------------------------------------------------------------------
 * I/VDS
 *
 * File:	vds/emsfixes/pdm/PDMloc_part.c
 *
 * Description:
 * This file contains the function PDMsearch_for_parts_in_catalog
 * which needed to be fixed to allow queries by hull_ap (CR7415).
 * As far as I can tell, we still don't have a master cvs repository
 * for the pdm/pdu code.  Which is kind of a bad thing.
 *
 * I pulled this file from jwfrosch:/ust7/source/pdm/pdms,
 * added this cvs header then checked it in unchanged.  I only needed the
 * one function so I copied it to PDMloc_part1.c.  So this file
 * is not intended to be compilied and is only here for reference.
 *
 * Dependencies:
 *
 * Revision History:
