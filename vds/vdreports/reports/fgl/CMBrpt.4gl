...
FUNCTION CMBmain()
  ...
  START REPORT CMBform TO "CMBform"
    OUTPUT TO REPORT CMBform ()
  FINISH REPORT CMBform
  ...
  START REPORT CMBmaterial TO "CMBmaterial"
	...
	ELSE
	   ...
	   CALL CMBconvert()
	   OUTPUT TO REPORT CMBmaterial ( elem_no )
	END IF
     END FOREACH
  FINISH REPORT CMBmaterial

  START REPORT CMBend TO PIPE "CMB.sh"
     OUTPUT TO REPORT CMBend ()
  FINISH REPORT CMBend 
  

  MESSAGE "Compartment report achieved"
  ...
  FORMAT
    FIRST PAGE HEADER
      ...
      PRINT COLUMN 1  , "DATE:", 
            ...
            COLUMN 51 , "C O M P A R T M E N T A T I O N",
            COLUMN 106, "Page - 1"
      ...
      IF p_vds.report_units = 1 THEN
        PRINT COLUMN 1,   "ITEM",
            ...
            COLUMN 70,  "CENTER OF VOLUME (FT)",
            COLUMN 96,  "SPACE CLASS",
            COLUMN 108, "ALLOC AR",
