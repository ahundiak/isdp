/* $Id: VDct1Mgr.c,v 1.3 2002/01/10 19:10:30 jdsauby Exp $  */
 ...
 * Revision History:
 *      $Log: VDct1Mgr.c,v $
 *      Revision 1.3  2002/01/10 19:10:30  jdsauby
 *      JTSMP CR 5679, added event gadgets to LIB and TREE forms.
 *
 *      Revision 1.2  2001/10/18 20:43:29  ahundiak
 *      ah
 *
...
static IGRstat activateNode(TGRid *nodeID)
{
  ...
  if (modelOE.obj_id.objid != NULL_OBJID) 
      	cmdInfo->eventID = modelOE.obj_id;
				...
				IGRint keepDefault)
{
  ...
  *formName = 0;
  ...
  // Get the first value
  sts = VDjt1GetGadgetText(&nodeJD,formName,gadget,0,bufFirst);
