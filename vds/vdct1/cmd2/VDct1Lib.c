/* $Id: VDct1Lib.c,v 1.5 2002/01/10 19:10:28 jdsauby Exp $  */
 ...
 * Revision History:
 *      $Log: VDct1Lib.c,v $
 *      Revision 1.5  2002/01/10 19:10:28  jdsauby
 *      JTSMP CR 5679, added event gadgets to LIB and TREE forms.
 *
 *      Revision 1.4  2002/01/07 18:55:20  jdsauby
 *      JTSMP CRs 4045,4048,4053,4054
 *
 *      Revision 1.3  2001/03/02 19:29:02  paul_noel
 *      Fix of Lib display problem JTS TR MP4794
 *
...
static IGRstat activateForm()
{
  ...
  if (!cmdInfo->sleep) VIg_disable(formInfo->form,VDCT_FORM_LIB_G_EVENT);
