/* $Id: VDct1StdAssyX.C,v 1.2 2001/02/20 15:22:35 ahundiak Exp $  */
				    ...
				    TVDxmlParseInfo  *parseInfo)
{
  ...
  *err = 0;
...
#if 0  // not sure that we need a parent check
  ...
  if (!strcmp(tag,XML_COP_STD_ASSY2) || 
    ...
    VDxmlParseGetParentEleType(parseInfo,1,parentEleType);
    if (strcmp(parentEleType,XML_COP_STD_ASSY2)) {
 ...
 */
IGRstat VDct1CopStdAssySaxCallback(TVDxmlParseInfo *parseInfo)
{
  IGRchar fn[] = "VDct1CopStdAssyFilterCallback";
