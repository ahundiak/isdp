...
#define FI_H_INCLUDED 1
	...
	/********************************************************/
	/*** These are X/Forms users' definitions of pointers ***/
	/********************************************************/
...
#define FI_EVENT_MASK  (ButtonPressMask | ButtonReleaseMask |\
    OwnerGrabButtonMask | KeyPressMask | ExposureMask |\
    StructureNotifyMask)

#define FI_ALL_EVENTS   ( ButtonPressMask | ButtonReleaseMask |\
...
#define FI_HORIZONTAL	1
	...
	/******************************************************/
	/*** Gadget labels reserved by the X/Forms library. ***/
	/******************************************************/
...
#define FI_SAVE_UNDER		0x00000001
...
#define FI_NO_ROW_BUTTONS	0x00000080
	...
	/********************************************/
	/*** These are the X/Forms screen defines ***/
	/********************************************/

#define FI_CURRENT_SCRN        -3
#define FI_DEFAULT_SCRN        -2
#define FI_HARDCODED_SCRN      -1

	/**********************************************************/
	/*** These are the obsolete I/Forms screen defines.	***/
	/*** Any application code referencing these should be	***/
	/*** changed to use the new X/Forms screen functions.	***/
	/**********************************************************/
...
#define FI_CALL_NOTIFICATION		2
	...
	/**********************************************/
	/*** Transition types for FIf_process_point ***/
	/**********************************************/
...
#define FI_INVALID_SYMBOL_FILE          28
#define FI_INVALID_SYMBOL_INDEX         29
