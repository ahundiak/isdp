...
mkptypes -e -A $FILE_LIST >./NEW_PROTO/EGdemo_p_all.h


###############################################################
### Extract private functions from EGdemo_p_all.h create EGdemo_p_pri.h
###############################################################

# Put header at beginning of EGdemo_p_pri.h ###
cat pri_hdr >./NEW_PROTO/EGdemo_p_pri.h

#  Get private functions
   cat ./NEW_PROTO/EGdemo_p_all.h 		>>./NEW_PROTO/EGdemo_p_pri.h
#   egrep -e ' \*_| _|/\*' ./NEW_PROTO/EGdemo_p_all.h 		>>./NEW_PROTO/EGdemo_p_pri.h
#egrep -v -e ' \*_| _|/\*' ./NEW_PROTO/EGdemo_p_all.h | grep .	>>./NEW_PROTO/EGdemo_p_pub.h
# Put footer at beginning of EGdemo_p_pri.h ###
cat pri_ftr >>./NEW_PROTO/EGdemo_p_pri.h

################################################################
### Check generated prototype files against the official copies.
################################################################

PROTO_FILE_LIST="EGdemo_p_all.h \
                 EGdemo_p_pri.h"
