...
mkptypes -e -A $FILE_LIST >./NEW_PROTO/EGwall_p_all.h


###############################################################
### Extract private functions from EGwall_p_all.h create EGwall_p_pri.h
###############################################################

# Put header at beginning of EGwall_p_pri.h ###
cat pri_hdr >./NEW_PROTO/EGwall_p_pri.h

#  Get private functions
   cat ./NEW_PROTO/EGwall_p_all.h 		>>./NEW_PROTO/EGwall_p_pri.h
#   egrep -e ' \*_| _|/\*' ./NEW_PROTO/EGwall_p_all.h 		>>./NEW_PROTO/EGwall_p_pri.h
#egrep -v -e ' \*_| _|/\*' ./NEW_PROTO/EGwall_p_all.h | grep .	>>./NEW_PROTO/EGwall_p_pub.h
# Put footer at beginning of EGwall_p_pri.h ###
cat pri_ftr >>./NEW_PROTO/EGwall_p_pri.h

################################################################
### Check generated prototype files against the official copies.
################################################################

PROTO_FILE_LIST="EGwall_p_all.h \
                 EGwall_p_pri.h"
