...
mkptypes -e -A $FILE_LIST >./NEW_PROTO/EGnav_p_all.h


###############################################################
### Extract private functions from EGnav_p_all.h create EGnav_p_pri.h
###############################################################

# Put header at beginning of EGnav_p_pri.h ###
cat pri_hdr >./NEW_PROTO/EGnav_p_pri.h

#  Get private functions
   cat ./NEW_PROTO/EGnav_p_all.h 		>>./NEW_PROTO/EGnav_p_pri.h
#   egrep -e ' \*_| _|/\*' ./NEW_PROTO/EGnav_p_all.h 		>>./NEW_PROTO/EGnav_p_pri.h
#egrep -v -e ' \*_| _|/\*' ./NEW_PROTO/EGnav_p_all.h | grep .	>>./NEW_PROTO/EGnav_p_pub.h
# Put footer at beginning of EGnav_p_pri.h ###
cat pri_ftr >>./NEW_PROTO/EGnav_p_pri.h

################################################################
### Check generated prototype files against the official copies.
################################################################

PROTO_FILE_LIST="EGnav_p_all.h \
                 EGnav_p_pri.h"
