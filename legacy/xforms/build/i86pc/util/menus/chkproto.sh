...
mkptypes -e -A $FILE_LIST |
  sed '/API_HANDLE_SHUTDOWN/d' >./NEW_PROTO/GMproto_all.h


###############################################################
### Extract private functions from GMproto_all.h create GMproto_pri.h
###############################################################

# Put header at beginning of GMproto_pri.h ###
cat pri_hdr >./NEW_PROTO/GMproto_pri.h

#  Get private functions
   cat ./NEW_PROTO/GMproto_all.h 		>>./NEW_PROTO/GMproto_pri.h
#   egrep -e ' \*_| _|/\*' ./NEW_PROTO/GMproto_all.h 		>>./NEW_PROTO/GMproto_pri.h
#egrep -v -e ' \*_| _|/\*' ./NEW_PROTO/GMproto_all.h | grep .	>>./NEW_PROTO/GMproto_pub.h
# Put footer at beginning of GMproto_pri.h ###
cat pri_ftr >>./NEW_PROTO/GMproto_pri.h

################################################################
### Check generated prototype files against the official copies.
################################################################

PROTO_FILE_LIST="GMproto_all.h \
                 GMproto_pri.h"
