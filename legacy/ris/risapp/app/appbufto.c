...
extern void RISapp_buf_to_execute(
	void)
{
	int		i;
...
extern void RISapp_buf_to_fetch(
	void)
{
	int offset;
	unsigned int i;
...
extern void RISapp_buf_to_close(
	void)
{
	int		i;
...
extern void RISapp_buf_to_clear(
	void)
{
	int	i;
...
extern int RISapp_buf_to_report_ss_error(
	ris_schema_error_info	*ss_error)
{
...
extern void RISapp_map_warnings(
	char warning_flag)
{
