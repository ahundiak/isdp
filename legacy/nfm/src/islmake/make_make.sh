Make_Makes ()
{
   for dir in   acad admin alpha alphas alter bulkload cmdtools convert \
                dbtools filetransfer fserver initial liberr libmem libnet \
                libqui libquis libsql marcomp nfma nfmcli nfmd \
                nfmfi_x nfmfis_x nfmlist nfmmonitor nfmr nfms nfmtools nfmu \
                nft sc systools update_util version wff_x wfg workflow
   ...
   nfmmkmk <NFMRuti.m > makefile_r$1
   nfmmkmk <NFMSuti.m > makefile_s$1
   nfmmkmk <NFMCuti.m > makefile_c$1
}
