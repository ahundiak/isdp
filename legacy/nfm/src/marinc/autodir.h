...
double chamferb;
short  coords;
short  curdimstyleno;    /* (R11), -1 if none */
short  curlayerindex;
short  curstyleindex;
short  curucsindex;
...
extern union  adenunion aden;
extern struct adenthdrstru adenhd;
extern struct adxdstru adxd;
