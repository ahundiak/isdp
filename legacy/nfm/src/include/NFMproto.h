...
long NFMdefine_set_information _P((char *catalog_name, long catalog_no, char *set_name, char *set_revision, long file_status_check, long members_to_define, struct NFMmember_info *members_info));

long NFMquery_set_members _P((long user_id, char *cat_name, char *item_name, char *item_rev, long level, long type, MEMptr *attr_list, MEMptr *data_list));

long NFMquery_project_members _P((long user_id, char *project_name, MEMptr *attr_list, MEMptr *data_list));

long NFMupdate_project_members _P((long user_id, MEMptr attr_list, MEMptr data_list));

long _NFMget_node_no _P((long user_id, char *node, char *node_num));

long NFMquery_add_st_area_attributes _P((long user_id, MEMptr *attr_list, MEMptr *data_list, MEMptr *value_list));

long NFMadd_storage_area _P((long user_id, MEMptr attr_list, MEMptr data_list));

long NFMchange_user_passwd _P((long user_id, char *user, char *old_pwd, char *new_pwd));

long NFMchange_storage_area_passwd _P((long user_id, char *storage_area, char *old_pwd, char *new_pwd));

long WFpurge_signoff _P((long user_id, char *catalog_name, char *item_name, char *item_rev)); 
