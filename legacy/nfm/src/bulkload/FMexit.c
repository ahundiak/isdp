...
static char *fname = "NFAexit";
    ...
    /*Added by MVR to avoid the unconnected exit status - 2 Mar 94.
    This avoids odd behavior when PF3 is tries while not connected to 
    any server */
    ...
    {
        status = NFMRset_user_defaults( NFMuser_id, logout_def );
