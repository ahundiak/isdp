...
/*
long NFMcreate_error_form (struct_data)
...
/*
    ...
    NFMput_string (&err_data->data[0], "NFMR");
    sprintf (error_num, "%d", NFMRmsg_ptr.error_no);
    NFMput_string (&err_data->data[1], error_num);
    NFMput_string (&err_data->data[2], NFMRmsg_ptr.error_msg);

    NFMput_string (&err_data->data[3], "NFM");
    sprintf (error_num, "%d", NFMmsg_ptr.error_no);
    NFMput_string (&err_data->data[4], error_num);
    NFMput_string (&err_data->data[5], NFMmsg_ptr.error_msg);

    NFMput_string (&err_data->data[6], "SQL");
    sprintf (error_num, "%d", SQLmsg_ptr.error_no);
    NFMput_string (&err_data->data[7], error_num);
    NFMput_string (&err_data->data[8], SQLmsg_ptr.error_msg);

    NFMput_string (&err_data->data[9], "DB");
    sprintf (error_num, "%d", DBmsg_ptr.error_no);
    NFMput_string (&err_data->data[10], error_num);
    NFMput_string (&err_data->data[11], DBmsg_ptr.error_msg);

    NFMput_string (&err_data->data[12], "NET");
    sprintf (error_num, "%d", NETmsg_ptr.error_no);
    NFMput_string (&err_data->data[13], error_num);
    NFMput_string (&err_data->data[14], NETmsg_ptr.error_msg);
*/
/*
    NFMput_string (&err_data->data[15], "MEM");
    sprintf (error_num, "%d", MEMmsg_ptr.error_no);
    NFMput_string (&err_data->data[16], error_num);
    NFMput_string (&err_data->data[17], MEMmsg_ptr.error_msg);
*/
/*
