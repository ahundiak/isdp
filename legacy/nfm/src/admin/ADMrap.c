...
static char *fname = "ADMbegin_record";
    ...
    NFMput_string (&data.data[0], "File Name" );
    NFMput_string (&data.data[1], "/usr/tmp/nfm.record");
...
static char *fname = "begin_playback";
    ...
    NFMput_string (&data.data[0], "Record Filename" );
    NFMput_string (&data.data[1], "Mode( s, i, r )");
    NFMput_string (&data.data[2], "/usr/tmp/nfm.record" );
