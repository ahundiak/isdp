...
#include "inc.h"
#endif
#define NFI_E_ITEM_LEN                   0x0801c11a
...
/* begin - PS  */
  ...
  field_len = 1000; /* assign some large value - PS */
   ...
   {
/*
         NFFform_message (CURRENT_LABEL, NFI_E_ITEM_LEN, "%d", field_len);
         sleep(1);
*/
         /* length = field_len ;  */ /* for truncation */
...
_NFIdebug ((fname, "_NFFfind_column_offset:write_offset = <%d>\n", write_offset));
    ...
    /* commented - srinivas 5th sept 1995  
