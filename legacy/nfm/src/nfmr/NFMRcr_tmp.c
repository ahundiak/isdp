...
/* 
 Doc: NFMRcreate_template
 
 Abstract:
     This function will create a template with a given set of attributes
     and data (modified buffers returned from NFMRquery_template_attributes).
 */
 
long NFMRcreate_template (user_id,table_name,table_type, attr_list,
			  data_list, value_list)

long    user_id;          /* i - user id for access */
char    *table_name;      /* i - name of template being created */
char    *table_type;      /* i - type of template being created */
...
static char *fname = "NFMRcreate_template";
    ...
    status = NFMcl_send_buffer (&NFMRglobal.NETid, NFM_CREATE_TEMPLATE, info);
