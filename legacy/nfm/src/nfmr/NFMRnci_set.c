...
long NFMRcheckin_set (catalog_name, catalog_no, set_name, set_revision, 
	set_no, working_area, wf_info, member_operations, operation, level)
...
static char *fname = "NFMRcheckin_set";
    ...
    status = NFMcl_send_buffer (&NFMRglobal.NETid, NFM_CHECKIN_SET, info);
