...
/* 
 Doc: NFMRdelete_catalog
 
 Abstract:
     This function will delete a catalog from I/NFM.
     
 */
 
long NFMRdelete_catalog (user_id, catalog_name)
...
static char *fname = "NFMRdelete_catalog";
    ...
    status = NFMcl_send_buffer (&NFMRglobal.NETid, NFM_DELETE_CATALOG, info);
