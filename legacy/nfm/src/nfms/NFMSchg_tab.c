...
static char *fname = "NFMSchange_table";
...
ret_status = NFMchange_table (user_id, data_ptr[1], data_ptr[2], attr_list,
                          data_list, value_list);
_NFMSdebug(( fname, "NFMchange_table <0x%.8x>\n", ret_status ));
