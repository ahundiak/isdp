...
/* 
 Doc: NFMScreate_template
 
 Abstract:
     This function will create a table template with a given set of attributes
     and data.
*/
 
long NFMScreate_template (in_list)
...
static char *fname = "NFMScreate_template";
...
ret_status = NFMcreate_template (user_id, data_ptr[1], data_ptr[2],
			     attr_list, data_list, value_list);
_NFMSdebug(( fname, "NFMcreate_template <0x%.8x>\n", ret_status));
