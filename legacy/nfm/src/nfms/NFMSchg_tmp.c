...
long NFMSchange_template (in_list)
...
static char *fname = "NFMSchange_template";
...
ret_status = NFMchange_template (user_id, data_ptr[1], data_ptr[2],
			     attr_list, data_list, value_list);
_NFMSdebug(( fname, "NFMchange_template <0x%.8x>\n", ret_status));
