...
long NFMSsave_set_files (in_list)
...
static char *fname = "NFMSsave_set_files";
    ...
    ret_status = NFMsave_set_files( data_ptr[0], data_ptr[1],data_ptr[2] );

    _NFMSdebug(( fname, "NFMsave_set_files  <0x%.8x>\n", ret_status));
...
long NFMSftr_save_set_files (in_list)
...
static char *fname = "NFMSftr_save_set_files";
    ...
    ret_status = NFMftr_save_set_files( data_ptr[0], data_ptr[1],data_ptr[2], 
			filesBuffer, keyBuffer );

    _NFMSdebug(( fname, "NFMftr_save_set_files  <0x%.8x>\n", ret_status));
