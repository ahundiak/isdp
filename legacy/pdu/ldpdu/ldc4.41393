...
ld \
	...
	-r -o ${PDU}/config/dload/init/NFMlib.o \
        ${PDU}/lib/NFMRtic.o \
	${NFM}/libc400/libnfma.a \
        ${NFM}/libc400/libnfmu.a \
        ${NFM}/libc400/libnfmlists.a \
        ${NFM}/libc400/libnfmsac.a \
        ${NFM}/libc400/libcmdtools.a \
        ${NFM}/libc400/libnfmwf.a \
        ${NFM}/libc400/libdbtools.a \
        ${NFM}/libc400/libnfmtools.a \
        ${NFM}/libc400/libnfmsql.a \
        ${NFM}/libc400/libfilexfer.a \
        ${NFM}/libc400/libtli.a \
        ${NFM}/libc400/libsystools.a \
        ${NFM}/libc400/libnfmmem.a \
        ${NFM}/libc400/libnfmnet.a \
        ${NFM}/libc400/libtli.a \
        ${NFM}/libc400/libnfmerr.a \
        ${PDU}/ldpdu/kumar.o \
...
ld \
	...
	${DBA}/lib/c400/script.o \
	${DBA}/lib/c400/dba.a \
	${DBA}/lib/c400/no_mcsl.o 
echo
