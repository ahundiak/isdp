...
# TR# 139526163. 05/jun/95 - raj.
# I can not see where ems_path is being used. Commented out.
...
# Remove NFMdaemon and NFMfileserver
 if [ -x $INGRHOME/nfm/bin/NFMdaemon ]
   ...
   rm $INGRHOME/nfm/bin/NFMdaemon
   rm $INGRHOME/nfm/bin/NFMfileserver
   rm /etc/rc0.d/K99nfm
   rm /etc/rc2.d/S99nfm
   rm /etc/init.d/nfm
   rm /etc/nfmd.conf
