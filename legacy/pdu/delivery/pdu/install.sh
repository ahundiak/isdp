...
#
   ...
   echo WARNING:
   echo
   echo I/PDU version 3.1 is dependent on I/PDM version 3.0+
   echo and NFM 3.4+ !!!!!!!
   echo
...
then
   ...
   c100ans=`getanswer "Install the C100 API libraries (y/n) ? " "y"`

   echo
   echo C400 API libraries require approximately ${PDUapi_c400} blocks.
   c400ans=`getanswer "Install the C400 API libraries (y/n) ? " "n"`
