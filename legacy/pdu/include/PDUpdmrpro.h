...
/* ./pdmr/PDMrassy.c */
extern int PDMget_assembly_structure __PDU((char *catalog, char *part, char *revision, int level, MEMptr *buffer));
...
/* ./pdmr/PDMrcanchko.c */
extern int PDMrcancel_checkout_part __PDU((char *catalog, char *part_num, char *revision, MEMptr attach_bufr, char ***file_name_list, int *row_count));
...
/* ./pdmr/PDMrchkin.c */
extern int PDMrcheckin_part __PDU((char *catalog, char *n_itemname, char *n_itemrev, MEMptr child_bufr, MEMptr attach_buffer, MEMptr view_buffer, MEMptr parm_buffer, MEMptr data_buffers, MEMptr param_ass_bufr));
...
/* ./pdmr/PDMrpart.c */
extern int PDMradd_part __PDU((char *catalog, char *partnum, char *rev, MEMptr attribute_buffer, MEMptr data_buffer, MEMptr add_buffer));
...
extern int PDMdelete_report __PDU((char *report_name));
...
/* ./pdmr/PDMruser.c */
extern int PDMrlogin __PDU((char *username, char *password, char *environment, int login_flag, long *user_id));
