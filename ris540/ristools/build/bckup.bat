@REM Do not alter this SPC information: $Revision: 1.3.27.1 $
@echo off
set SUB=to
set SUBDIR=ristools
...
:usage
echo.
echo Usage: bckup -z    Create backup zip file
echo        bckup -t    Create backup tree
echo        bckup -l	Create backup listing
goto exit
