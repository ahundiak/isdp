...
static BOOL UseDlgSectionCategory(
...
//	FALSE = Failure loading the category dialog resource. 
// -----------------------------------------------------------------------
static BOOL AdjustDlgSectionLoad(
	LPDLGSECTION lpdlgsec)
{
  int			i;
...
extern int AddDlgSectionCategory(
	LPDLGSECTION lpdlgsec,
	HINSTANCE hinst,
...
extern int DeleteDlgSectionCategory(
	LPDLGSECTION lpdlgsec,
	int nID)
{
  LPSECTIONCATEGORY	lpseccat;
...
extern BOOL SelectDlgSectionCategory(
	LPDLGSECTION lpdlgsec,
	int nID)
{
  RECT			rcFrame;
...
extern BOOL SetDlgSectionThreshold(
	LPDLGSECTION lpdlgsec,
	int nMinThreshold,
	int nMaxThreshold)
{
...
static LPSECTIONCATEGORY GetDlgSectionCategory(
...
extern int GetDlgSectionCurrentID(
	LPCDLGSECTION lpdlgsec)
{
...
extern LPVOID GetDlgSectionData(
	LPCDLGSECTION lpdlgsec)
{
  CHECK_PARAMETER(lpdlgsec, NULL);
